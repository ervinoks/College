...
class Program
{
    ...
    private static bool CheckSunk(ref char[,] Board, int Row, int Column, ref ShipType[] Ships)
    {
    ...
    private static void MakePlayerTorpedoMove(ref char[,] Board, ref ShipType[] Ships)
    {
        int Row = 0;
        int Column = 0;
    ...
    {
        Ships[0].Name = "Air craft Carrier";
        Ships[0].Size = 5;
